            ...
            <div class="col-sm-6 col-md-offset-3">
                <form method="post" action="/board/boardInsert" enctype="multipart/form-data">
					...
					<div class="form-group"> <!-- Subject field -->
						...
						<input class="form-control" id="bititle" name="bititle" type="text" disabled/>
					</div>
					
					<div class="form-group"> <!-- Message field -->
						<label class="control-label " for="bitext">내용</label>
						<textarea class="form-control" cols="40" id="bitext" name="bitext" rows="10" disabled></textarea>
					</div>
					...
					<div class="form-group">
						...
						<button class="btn btn-primary " data-page="/board/boardList">취소</button>
					</div>
